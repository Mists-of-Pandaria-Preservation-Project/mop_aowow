...
class SpellList extends DBTypeList
{
    ...
    public const INTERACTIVE_NONE     = 0;
    public const INTERACTIVE_EMBEDDED = 1;                  // parse combat ratings to %
    public const INTERACTIVE_FULL     = 2;                  // additionaly allow links and hover tooltips
